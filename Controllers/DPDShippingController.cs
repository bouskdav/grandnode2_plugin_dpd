...
{
    public class DPDShippingController : Controller
    {
        ...
        //    if (shippingPoint == null) return Content("DPDShippingController: given Shipping Option doesn't exist");
        ...
        public async Task<IActionResult> Points(string shippingOption)
        {
            ...
            if (parameter != _translationService.GetResource("Shipping.DPD.PluginName"))
                return Content("DPDShippingPointController: given Shipping Option doesn't exist");
            ...
            //    new() { Value = "", Text = _translationService.GetResource("Shipping.DPD.SelectShippingOption") }
            //};
