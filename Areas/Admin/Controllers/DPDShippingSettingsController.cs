...
namespace Shipping.DPD.Controllers
{
    [AuthorizeAdmin]
    [Area("Admin")]
    [PermissionAuthorize(PermissionSystemName.ShippingSettings)]
    public class DPDShippingSettingsController : BaseShippingController
    {
        private readonly IWarehouseService _warehouseService;
        private readonly IShippingMethodService _shippingMethodService;
        private readonly IStoreService _storeService;
        private readonly ICountryService _countryService;
        private readonly DPDShippingSettings _shippingDPDSettings;
        private readonly IDPDShippingService _shippingDPDService;
        ...
        public DPDShippingSettingsController(
            IWarehouseService warehouseService,
            IShippingMethodService shippingMethodService,
            IStoreService storeService,
            ICountryService countryService,
            DPDShippingSettings shippingDPDSettings,
            IDPDShippingService shippingDPDService,
            ...
            MeasureSettings measureSettings)
        {
            ...
            _shippingDPDSettings = shippingDPDSettings;
            _shippingDPDService = shippingDPDService;
        ...
        {
            var model = new DPDShippingListModel();

            model.LimitMethodsToCreated = _shippingDPDSettings.LimitMethodsToCreated;
            model.DisplayOrder = _shippingDPDSettings.DisplayOrder;
        ...
        public async Task<IActionResult> SaveGeneralSettings(DPDShippingListModel model)
        {
            //save settings
            _shippingDPDSettings.LimitMethodsToCreated = model.LimitMethodsToCreated;
            _shippingDPDSettings.DisplayOrder = model.DisplayOrder;

            await _settingService.SaveSetting(_shippingDPDSettings);
        ...
        //{
        //    var records = await _shippingDPDService.GetAll(command.Page - 1, command.PageSize);

        //    var sbwModel = new List<DPDShippingModel>();
        //    foreach (var x in records)
        //    {

        //        var m = new DPDShippingModel
        //        {
        //            Id = x.Id,
        //            StoreId = x.StoreId,
        ...
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.DPD.Fields.From"), m.From);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.DPD.Fields.To"), m.To);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.DPD.Fields.AdditionalFixedCost"), m.AdditionalFixedCost);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.DPD.Fields.RatePerWeightUnit"), m.RatePerWeightUnit);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.DPD.Fields.LowerWeightLimit"), m.LowerWeightLimit);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.DPD.Fields.PercentageRateOfSubtotal"), m.PercentageRateOfSubtotal);
        ...
        //{
        //    var sbw = await _shippingDPDService.GetById(id);
        //    if (sbw != null)
        //        await _shippingDPDService.DeleteDPDShippingRecord(sbw);
        ...
        //[HttpPost]
        //[AutoValidateAntiforgeryToken]
        //public async Task<IActionResult> AddPopup(DPDShippingModel model)
        //{
        //    var sbw = new DPDShippingRecord
        //    {
        ...
        //    };
        //    await _shippingDPDService.InsertDPDShippingRecord(sbw);
        ...
        //[HttpPost]
        //[AutoValidateAntiforgeryToken]
        //public async Task<IActionResult> EditPopup(DPDShippingModel model)
        //{
        //    var sbw = await _shippingDPDService.GetById(model.Id);
        //    if (sbw == null)
        //        //No record found with the specified id
        //        return RedirectToAction("Configure");
        ...
        //    await _shippingDPDService.UpdateDPDShippingRecord(sbw);
